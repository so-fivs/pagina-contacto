      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
          ...
          <div className="md:w-1/2 text-left">
            <h2 className="text-3xl font-semibold mb-4 text-white-800">Únete a nuestro equipo</h2>
...
<div className="text-center">
  <button 
    type="submit" 
    className="bg-gray-600 text-white py-3 px-6 rounded-lg hover:bg-gray-700 transition duration-200 shadow-md">
    Enviar Solicitud
  </button>
</div>
